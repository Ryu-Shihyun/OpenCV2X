...
#include "artery/application/den/HlnWcwUseCase.h"
...
Define_Module(artery::den::HlnWcw)
...
void HlnWcw::initialize(int stage)
{
...
void HlnWcw::check()
{
    // Need to check if we are sending at the correct rate.
    // Check if sending at right rate.
    if ((simTime() - mLastTransmission > mInterval) & (mActive)){
...
void HlnWcw::indicate(const artery::DenmObject& denm) {
...
vanetza::asn1::Denm HlnWcw::createMessage()
{
...
vanetza::btp::DataRequestB HlnWcw::createRequest()
{
